...
<html lang="en">
  ...
  <body>
    ...
    <nav class="navbar navbar-default navbar-fixed-top probootstrap-navbar">
      <div class="container">
        ...
        <div id="navbar-collapse" class="navbar-collapse collapse">
            <a class="button" style="margin-top: 35px; margin-left: 15px; margin-right: 0px; float: right;" href="<?php echo base_url('index.php/login');?>"><i class="bi bi-box-arrow-in-right" style="margin-right: 10px;" ></i>Login</a> 
            <ul class="nav navbar-nav navbar-right">
                <li class="active"><a href="#" data-nav-section="welcome">Welcome</a></li>
                <li><a href="#" data-nav-section="kategory">Kategory Produk</a></li>
                <li><a href="#" data-nav-section="produk">Produk</a></li>
                <li><a href="#" data-nav-section="pesan">Buy</a></li>
    ...
    <section class="probootstrap-section-bg overlay" style="background-image: url<?php echo base_url('assets/img/hero_bg_2.jpg')?>;" data-stellar-background-ratio="0.5" data-section="kategory">
      <div class="container">
        <div class="row">
    ...
    <section class="probootstrap-section-bg overlay" style="background-image: url(<?php echo base_url('assets/img/hero_bg_4.jpg')?>);"  data-stellar-background-ratio="0.5" data-section="produk">
        <div class="container">
            <div class="row">
            <div class="col-md-12 text-center probootstrap-animate">
                <div class="probootstrap-heading">
    ...
    <section class="probootstrap-section-bg overlay" style="background-image: url(<?php echo base_url('assets/img/hero_bg_5.jpg')?>);"  data-stellar-background-ratio="0.5" data-section="pesan">
      <div class="container">
        <div class="row">
          <div class="col-md-12 text-center probootstrap-animate">
            <div class="probootstrap-heading">
              ...
              <a class="button" href="<?php echo base_url('index.php/login');?>"><i class="bi bi-basket" style="margin-right: 10px;" ></i>Beli Sesuatu</a>
            </div>
          </div>
        </div>
      </div>
